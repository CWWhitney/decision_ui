...
import { CHART_COLORS, getDefaultHistogramLegend, getDefaultChartOptions, getDefaultChartScales } from "../common";
...
export const drawCombinedResultsHistogram = (
    ...
    return new Chart<"bar">(ctx, {
        ...
        options: {
            ...
            ...getDefaultChartScales(max_ticks, bins, TEXT_COLOR, GRID_COLOR),
