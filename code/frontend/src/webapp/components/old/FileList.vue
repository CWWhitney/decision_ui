<script setup lang="ts">
    ...
    import { doDeleteModel, doQueryModels, type ModelData } from "../../rest/models";
                    ...
                    <v-btn-group>
                        ...
                        <v-tooltip location="bottom" text="go to help section" open-delay="500">
                            <template #activator="{ props }">
                                <v-btn
                                    v-bind="props"
                                    to="/user/workspace/help/user-interface/model-list/"
                                    color="primary"
                                >
                                    <template #prepend>
                    ...
                    <v-list v-else class="list" lines="two">
                        ...
                        >
                            ...
                            <template #append>
                                ...
                                <v-btn icon="mdi-trash-can-outline" size="small" @click.stop="deleteModel(model)">
                                </v-btn>
                            </template>
                        </v-list-item>
